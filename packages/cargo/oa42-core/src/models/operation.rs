...
impl OperationContainer {
  ...
  #[wasm_bindgen(getter = authenticationRequirements)]
  ...
  #[wasm_bindgen(getter = queryParameters)]
  ...
  #[wasm_bindgen(getter = pathParameters)]
  ...
  #[wasm_bindgen(getter = cookieParameters)]
  ...
  #[wasm_bindgen(getter = operationResults)]
